...
parser = argparse.ArgumentParser(description="Exploration of Windows Application Event Log generated by the Powershell command: get-winevent -Path log.evtx | export-csv -delimiter ';' log.csv")
...
applicationevts = {(7, "Symantec AntiVirus"): "Symantec Endpoint Protection new virus definition file loaded",
                   ...
                   (2, "Symantec AntiVirus"): "Symantec AntiVirus Scan result",
                   (3, "Symantec AntiVirus"): "Symantec AntiVirus Scan started",
