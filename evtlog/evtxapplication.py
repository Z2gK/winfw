# -*- coding: utf-8 -*-
"""
Created on Mon Jul  6 14:51:05 2020
...
parser = argparse.ArgumentParser(description="Exploration of Windows System Event Log generated by the Powershell command: get-winevent -Path log.evtx | export-csv log.csv")
...
# This filters on the (Id, ProviderName) tuple
# Symantec Endpoint Protection and Symantec Network Protection are valid ProviderNames as well
applicationevts = {(7, "Symantec AntiVirus"): "Symantec Endpoint Protection new virus definition file loaded",
                   (13, "Symantec AntiVirus"): "Symantec Endpoint Protection service shutdown successfully",
                   (14, "Symantec AntiVirus"): "Symantec Endpoint Protection service startup successfully",
                   (21, "Symantec AntiVirus"): "Symantec Endpoint Protection scan cancelled",
                   (1, "McAfee Endpoint Security"): "McAfee Endpoint Security update in progress",
                   (2, "McAfee Endpoint Security"): "McAfee Endpoint Security update error",
                   (3, "McAfee Endpoint Security"): "McAfee Endpoint Security detects USB inserted",
                   (34057, "Symantec AntiVirus"): "A component of Symantec Endpoint Protection has been enabled (Event ID 34057)",
                   (34054, "Symantec AntiVirus"): "A component of Symantec Endpoint Protection has been enabled (Event ID 34054)",
                   (34053, "Symantec AntiVirus"): "A component of Symantec Endpoint Protection has been disabled (Event ID 34053)"
}


pd.set_option('display.max_rows', None)

print("\n\n---- [Filtered Data Set] Events relating to endpoint protection ----")
for k in applicationevts:
    df3 = df3 = df2[(df2["Id"] == k[0]) & (df2["ProviderName"] == k[1])]
    if not df3.empty:
        print("\nEvent: " + applicationevts[k])
        print(df3["TimeCreated"])

# df3 = df2[(df2["Id"] == 3) & (df2["ProviderName"] == "Symantec AntiVirus")]
#df3 = df2[(df2["ProviderName"] == "Symantec AntiVirus")]
#print(df3[["Id","Message", "TimeCreated"]])
#df3 = df2[(df2["ProviderName"] == "Symantec Endpoint Protection")]
#print(df3[["Id","Message", "TimeCreated"]])
