...
parser = argparse.ArgumentParser(description="Exploration of Windows Security Event Log generated by the Powershell command: get-winevent -Path log.evtx | export-csv log.csv")
