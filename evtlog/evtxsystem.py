...
parser = argparse.ArgumentParser(description="Exploration of Windows System Event Log generated by the Powershell command: get-winevent -Path log.evtx | export-csv -delimiter ';' log.csv")
