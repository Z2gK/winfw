# read a csv generated from an evtx file and perform basic summary

import argparse
import pandas as pd

parser = argparse.ArgumentParser(description="Exploration of Windows Event Log generated by the Powershell command: get-winevent -Path log.evtx | export-csv -delimiter ';' log.csv")
